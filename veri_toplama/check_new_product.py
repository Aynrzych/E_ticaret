#!/usr/bin/env python3
"""
Yeni eklenen ürünlerin hangi sitelerde mevcut olduğunu kontrol eder
"""
import json
        ...
        try:
            ...
            for site in ['hepsiburada', 'trendyol', 'n11', 'pttavm', 'pazarama']:
                if site in sites:
                    ...
                    for vendor in sites[site][:2]:  # İlk 2 satıcı
            ...
            if missing_sites:
                ...
                print("   Bu normal olabilir - ürün o sitelerde satılmıyor olabilir.")
